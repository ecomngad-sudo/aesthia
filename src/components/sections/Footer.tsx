...
const [success, setSuccess] = useState(false);
  ...
  const response = await fetch("https://formspree.io/f/mrpzzlvd", {
    ...
    body: JSON.stringify({ ...formData, redirect: "false" }),
  });
  ...
  personalized Med Spa Growth Audit.
        ...
        <div className="grid gap-12 py-20 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-8 space-y-3 text-sm text-white/60">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:hello@aesthia.com" className="transition hover:text-gold-300">
                  hello@aesthia.com
                </a>
              </div>
          ...
          <FooterColumn
            title="Services"
            links={[
              { label: 'Luxury Websites', href: '#luxury-websites' },
              { label: 'Google Business', href: '#google-business' },
              { label: 'Local SEO', href: '#local-seo' },
              { label: 'AI Booking', href: '#ai-booking' },
